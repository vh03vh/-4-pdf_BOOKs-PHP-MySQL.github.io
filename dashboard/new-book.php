...
?>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        //اكواد تحميل  صورة من قاعدة البيانات 
        // Book Cover
        ...
        //<div class='alert alert-danger'>" . "الرجاء ملء الحقول أدناه" . "</div>"; احد الاكواد من كلاسات bootstrap
        ...
        if (empty($bookTitle) || empty($bookAuthor) || empty($bookCat) || empty($bookContent)) {
            ...
            //melaffayy swaaa kant swr or file bnfs tari9a
            // Book cover
    ...
    <div class="container-fluid">
        <!-- Start new book -->
        <div class="new-book">
            <!-- hada mn ajl msr nt3 danger najah ow lm ytm najah -->
            <?php
            if (isset($error)) {
                echo $error;
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="bookCat">
                        <option></option>
                        <!-- جلب المتغيرا او  catgoryName من الجزدل في قاعدة البيانات  لتظهر على  شكل   -->
                        <?php
